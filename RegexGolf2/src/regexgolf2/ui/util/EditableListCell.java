...
/**
 * The EditableListCell consists of two main UI components.
 * On the left is the editable Label and on the right is a Panel
 * that can be filled by Subclasses via the {@link #setContent(Node)} method.
 * To access the text of the editable Label, simply use the {@link #textProperty()}.
 */
public class EditableListCell<T> extends ListCell<T>
{
	 ...
	 * @param node  The content node, or null to clear the Panel.
	 */
	...
	/**
	 * This method is called if the item changes.
	 * Inside this method, every Property that was bound to the Item
	 * somehow; should unbind again.
	...
	/**
	 * This method is called after the item was updated.
	 * If you need to make bindings to the item, do them here.
	 */
	protected void bind()
	{
